...
export const fetchAdminStations = createAsyncThunk('stations/fetch', async (params = {}, { rejectWithValue }) => {
  try {
...
export const updateStationStatus = createAsyncThunk('stations/updateStatus', async ({ id, action }, { rejectWithValue }) => {
  try {
...
const stationsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchAdminStations.pending, (state) => { state.loading = true; })
