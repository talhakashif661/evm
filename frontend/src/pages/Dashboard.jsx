              ...
              <>
                ...
                <div className="col-6 col-md-3">
                  <StatCard
                    ...
                    value={
                      evs.length
                        ? `${Math.round(evs.reduce((a, e) => a + e.batteryPercentage, 0) / evs.length)}%`
                        : '--'
                    }
                    icon={<BatteryCharging size={22} />}
                    color={
                      evs.some((e) => e.batteryPercentage < 20) ? 'var(--danger)' : 'var(--success)'
                    }
                  />
                </div>
              </>
                ...
                >
                  ...
                  <Link to="/evs">
                    <button
                      ...
                      style={{ padding: '6px 16px', fontSize: '0.8rem', gap: 4 }}
                    >
                  ...
                  <div style={{ textAlign: 'center', padding: '24px 0' }}>
                    ...
                    <Link to="/stations">
                      <button
                        ...
                        style={{ padding: '8px 20px', fontSize: '0.85rem' }}
                      >
                        Find Your First Station <ArrowRight size={14} />
                      </button>
                    </Link>
                  </div>
                ) : (
            ...
            {[
              {
                ...
                icon: Zap,
                label: 'Find Stations',
                desc: 'Browse charging locations',
              },
          ...
          {stationLoading ? (
            ...
            <>
              ...
              <motion.div variants={itemVariants} className="ev-card" style={{ padding: 24 }}>
                ...
                >
                  <div>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem' }}>
                      {myStation.address}, {myStation.city}
                    </p>
                  </div>
                  <span
                ...
                <Link to="/owner/station">
                  ...
                  >
                    Manage Station <ArrowRight size={14} />
                  </button>
                </Link>
              </motion.div>
            </>
            ...
            >
              <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'center' }}>
                <Zap size={48} color="var(--gold)" strokeWidth={1.5} />
              </div>
              <h2
                style={{
                  fontFamily: 'Georgia, "Times New Roman", serif',
              ...
              <p style={{ color: 'var(--text-muted)', marginBottom: 24 }}>
                Register your charging station to start accepting bookings.
              </p>
              <Link to="/owner/station">
