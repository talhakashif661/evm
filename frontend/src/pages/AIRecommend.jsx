    ...
    <div style={{ maxWidth: 1000, margin: '0 auto', padding: '44px 32px' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
          Intelligent station selection based on distance, price, availability & urgency
        </p>
      </div>
          ...
          <div className="row g-3">
            {evs.length > 0 && (
              <div className="col-12 col-md-4">
                <label className="form-label" htmlFor="ai-quickfill">
                  Quick Fill from EV
                </label>
                <select
                  id="ai-quickfill"
            ...
            <div className="col-6 col-md-3">
              <label className="form-label" htmlFor="ai-lat">
                Latitude
              </label>
              <input
                id="ai-lat"
            ...
            <div className="col-6 col-md-3">
              <label className="form-label" htmlFor="ai-lng">
                Longitude
              </label>
              <input
                id="ai-lng"
            ...
            <div className="col-6 col-md-3">
              <label className="form-label" htmlFor="ai-battery">
                Battery Level (%)
              </label>
              <input
                id="ai-battery"
      ...
      {meta?.isEmergency && (
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem' }}>
            Emergency priority mode active. Nearest available stations are ranked highest.
          </p>
        </motion.div>
      )}
              ...
              return (
                <motion.div
                  ...
                  style={{
                    padding: 24,
                    marginBottom: 16,
                    borderLeft: i === 0 ? '3px solid var(--gold)' : '1px solid var(--border)',
                  }}
                >
                    ...
                    <div className="col-12 col-md-3">
                      ...
                      >
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                          ...
                          <span
                            style={{
                              ...
                              fontSize: '0.85rem',
                              color:
                                station.aiMetrics.availableSlots > 0
                                  ? 'var(--success)'
                                  : 'var(--danger)',
                            }}
                          >
                        ...
                        <div
                          ...
                          title="Estimated from current queue length — shown for reference, not used in the AI score above"
                        >
                          <span style={{ color: 'var(--text-muted)', fontSize: '0.78rem' }}>
                            Est. Wait
                          </span>
                          <span style={{ fontWeight: 600, fontSize: '0.85rem' }}>
                            ~{station.aiMetrics.estimatedWaitMinutes} min
                          </span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                          <span style={{ color: 'var(--text-muted)', fontSize: '0.78rem' }}>
                          ...
                          <span
                            style={{ fontWeight: 600, fontSize: '0.85rem', color: 'var(--gold)' }}
                          >
                            {toPKR(station.pricePerKwh)}/kWh
                          </span>
                        </div>
                      </div>
