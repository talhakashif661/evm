    ...
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:24,
      ...
      <motion.div initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} style={{ width:'100%', maxWidth:420 }}>
        ...
        <div style={{ textAlign:'center', marginBottom:36 }}>
          ...
          <h1 style={{ fontFamily:'Georgia, "Times New Roman", serif', fontSize:'2.4rem', fontWeight:700, letterSpacing:'0.02em', marginBottom:8 }}>
            Welcome <span style={{ color:'var(--primary)' }}>Back</span>
          </h1>
          <p style={{ color:'var(--text-secondary)', fontSize:'0.88rem' }}>Sign in to EV Management System</p>
        </div>
        ...
        <div className="ev-card" style={{ padding:32 }}>
          ...
          {/* Admin Access note */}
          <div style={{ marginTop:20, padding:'12px 16px', background:'#DEE6EC',
            border:'1px solid #B9C7D3', borderRadius:4, textAlign:'center' }}>
            <p style={{ color:'var(--accent)', fontSize:'0.82rem', fontWeight:600 }}>Admin Access</p>
