...
export const fetchRecommendations = createAsyncThunk('ai/recommend', async (params, { rejectWithValue }) => {
  try {
...
const aiSlice = createSlice({
  ...
  reducers: { clearRecommendations: (state) => { state.recommendations = []; state.meta = null; } },
