    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          {email && (
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem' }}>for {email}</p>
          )}
        </div>
          ...
          {!token || !email ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <Link
                to="/forgot-password"
                className="btn-gold"
                style={{ padding: '10px 22px', textDecoration: 'none' }}
              >
                Request a New Link
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label className="form-label" htmlFor="reset-newPw">
                  New Password
                </label>
                <input
                  id="reset-newPw"
              ...
              <div className="mb-4">
                <label className="form-label" htmlFor="reset-confirmPw">
                ...
                {confirm && confirm !== newPassword && (
                  <small style={{ color: 'var(--error)' }}>Passwords don&apos;t match</small>
                )}
              </div>
              <button
                type="submit"
