    ...
    <div className="app-shell">
      ...
      <Suspense fallback={<Spinner />}>
        ...
        <Routes>
          ...
          <Route path="/auction"   element={<PrivateRoute><AuctionHub /></PrivateRoute>} />
          <Route path="/evs"       element={<PrivateRoute><EVManagement /></PrivateRoute>} />
          <Route path="/ai-recommend" element={<PrivateRoute><AIRecommend /></PrivateRoute>} />
          <Route path="/profile"   element={<PrivateRoute><Profile /></PrivateRoute>} />

          {/* Station Owner routes */}
          <Route path="/owner/station"  element={<PrivateRoute roles={['STATION_OWNER']}><OwnerDashboard /></PrivateRoute>} />
          <Route path="/owner/slots"    element={<Navigate to="/owner/station" replace />} />
          <Route path="/owner/bookings" element={<Navigate to="/owner/station" replace />} />
          <Route path="/owner/reports"  element={<PrivateRoute roles={['STATION_OWNER']}><StationReport /></PrivateRoute>} />
